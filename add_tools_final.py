...
def rebuild():
    ...
    # Drop non-integer IDs if any slipped in (id column isn't strictly integer in sqlite unless STRICT, but main.py might expect int)
    ...
    for t in TOOLS:
        if t["name"] not in seen_names:
            ...
            # Since some schema issues happened let's only insert what we absolutely need
            c.execute('''
