...
2026-07-27 | SEO | Uppdaterat INDEXING_LOG.md
2026-07-26 | DESIGN | Enhetlig navigering, länkade "Skapa med AI" | Menykonsekvens
2026-07-28 | DESIGN/UX | Lade till 'Skapa' länk i navigationen på alla sidor för att enhetliggöra navigeringsmenyn | UX-lyft | nästa: Optimera leads eller lägg in fler affiliate-verktyg
...
2026-06-24 | SEO/TILLVÄXT | Ny landningssida 'Lär dig AI' (utbildningshub) | Fånga sökintention & volym | nästa: Bygg SEO-sida för 'Bygg med AI' eller utöka datamoat
2026-06-23 | SEO/TILLVÄXT | Ny dedikerad landningssida för 'AI Program' | Fånga sökintention & volym | nästa: Bygg SEO-sidor för 'Lär dig AI' & 'Bygg med AI'
...
## 2026-07-31 – Datalagret flyttat till Postgres

All inskickad data försvann var 24:e timme. `database.py` hårdkodade
`sqlite:///./tools.db` på containerdisken, Railway-tjänsten saknar volym och
redeployar dagligen. Samtliga fem tabeller stod på noll rader vid granskning.
Leads nådde ändå inkorgen tack vare `mailer.notify_owner`; kalkylatordatan, som
saknade mejlkopia, försvann spårlöst.

`DATABASE_URL` styr nu anslutningen, med SQLite som fallback för lokal körning
och en varning i startloggen när fallbacken används. URL:er normaliseras så att
både `postgres://` och `postgresql://` från Railway fungerar med psycopg 3.
`data_moat_calc.csv` är borta – kalkylatordata går till tabellen `calc_data`,
som fått en skyddad exportendpoint.
